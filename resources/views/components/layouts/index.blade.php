            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="forms-layouts.html">
                        <i class="bi bi-circle"></i><span>Tomarrow Bookings</span>
                    </a>
                </li>
                <li>
                    <a href="forms-editors.html">
                        <i class="bi bi-circle"></i><span>This Week Bookings</span>
                    </a>
                </li>
                <li>
...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>Softwere</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
        ...
        Designed by <a href="https://t.me/orifjon_oripov/">Orifjon Oripov</a>
    </div>
</footer><!-- End Footer -->
